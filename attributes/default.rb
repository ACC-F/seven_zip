...
if node['kernel']['machine'] == 'x86_64'
  default['seven_zip']['url']          = 'http://sourceforge.net/projects/sevenzip/files/7-Zip/15.14/7z1514-x64.msi/download'
  ...
  default['seven_zip']['url']          = 'http://sourceforge.net/projects/sevenzip/files/7-Zip/15.14/7z1514.msi/download'
